...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD get_instance_features.
    ...
    READ ENTITIES OF zi_rap_travel_man IN LOCAL MODE
      ENTITY Travel
  ...
  METHOD acceptTravel.
    ...
    MODIFY ENTITIES OF zi_rap_travel_man IN LOCAL MODE
      ENTITY Travel
         UPDATE
           FIELDS ( TravelStatus )
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-AgencyID IS INITIAL OR NOT line_exists( agencies_db[ agency_id = travel-AgencyID ] ).
        ...
        APPEND VALUE #( %tky              = travel-%tky
                        ...
                        textid   = zcm_rap_man=>agency_unknown
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-CustomerID IS INITIAL OR NOT line_exists( customers_db[ customer_id = travel-CustomerID ] ).
        ...
        APPEND VALUE #( %tky                = travel-%tky
                        ...
                        %msg                = NEW zcm_rap_man(
                        severity   = if_abap_behv_message=>severity-error
                        textid     = zcm_rap_man=>customer_unknown
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-EndDate < travel-BeginDate.
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        ...
                        %msg               = NEW zcm_rap_man(
                        severity  = if_abap_behv_message=>severity-error
                        textid    = zcm_rap_man=>date_interval
      ...
      ELSEIF travel-BeginDate < cl_abap_context_info=>get_system_date( ).
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        ...
                        %msg               = NEW zcm_rap_man(
                        severity  = if_abap_behv_message=>severity-error
                        textid    = zcm_rap_man=>begin_date_before_system_date
                        begindate = travel-BeginDate )
      ...
      IF is_update_requested = abap_true.
        ...
        IF has_before_image = abap_true.
          ...
          IF update_granted = abap_false.
            APPEND VALUE #( %tky = travel-%tky
                            %msg = NEW zcm_rap_man( severity = if_abap_behv_message=>severity-error
                                                    textid   = zcm_rap_man=>unauthorized )
                          ) TO reported-travel.
          ENDIF.
...
endmethod.
    ...
    METHOD is_create_granted.
      AUTHORITY-CHECK OBJECT 'ZOSTATman'
        ID 'ZOSTATman' DUMMY
        ID 'ACTVT' FIELD '01'.
    ...
    METHOD is_delete_granted.
      IF has_before_image = abap_true.
        AUTHORITY-CHECK OBJECT 'ZOSTATman'
          ID 'ZOSTATman' FIELD overall_status
          ID 'ACTVT' FIELD '06'.
      ELSE.
        AUTHORITY-CHECK OBJECT 'ZOSTATman'
          ID 'ZOSTATman' DUMMY
